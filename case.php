...
<!-- Mirrored from swiftsources.com/case by HTTrack Website Copier/3.x [XR&CO'2017], Sun, 27 Mar 2022 07:06:46 GMT -->
...
<link href="fonts.googleapis.com/css?family=Montserrat:200,300,400,500,600,700,800&amp;display=swap" rel="stylesheet">
...
<script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/62cc059d7b967b117998fb70/1g7mfbshg';
        s1.charset='UTF-8';
...
<input type="text" class="form-control" id="fname" name="f_name" placeholder="First Name" value="" required>
...
<input type="text" name="l_name" class="form-control" id="name" placeholder="Last Name" value="" required>
<div class="invalid-feedback">
Valid last name is .
</div>
</div>
...
<div class="col-12">
<div class="input-group has-validation">
<select class="input-group-text" name="paymentMethod">
<option  id="paymentMethod" >Payment method</option>
...
<select class="input-group-text" name="lost">
<option class="form-control" value="" id="lost" >How did you lose your money</option>
...
<script type="text/javascript">(function(){window['__CF$cv$params']={r:'6f26490eae3c407d',m:'uDODvvKY.TVBiZRo1QwBcIxAVBHQ0WLdT5DxvOvqBCg-1648364807-0-AXy59QxBqiZY85I8wjPQQOtjWqKd8W24xx42piSj6tOyyADGVVpEWxjR2OuEkpQ5tnPi20QzxDYQC31knlSNRWUVu2z7ZcrxM0VjLZ4pWftdQAUTev6WruvoFyCeXvz6Ng==',s:[0xe1e83ddb7c,0x9744eb2bf3],u:'/cdn-cgi/challenge-platform/h/b'}})();</script></body>

<!-- Mirrored from swiftsources.com/case by HTTrack Website Copier/3.x [XR&CO'2017], Sun, 27 Mar 2022 07:06:48 GMT -->
</html>
<?php
    if(isset($_GET["success"])){
        ?>
        <script>
            alert("Your case has been reported successfully, We will get back to you as soon as possible")
        </script>
        <?php
    }else{
        ?>
